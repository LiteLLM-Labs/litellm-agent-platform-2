...
Drop a new folder under `src/llms/providers/`:
...
editing. See `src/llms/providers/anthropic/` for a reference implementation.
...
src/
  ...
  sdk/         # Agent Runtime SDK client + runtime adapters
