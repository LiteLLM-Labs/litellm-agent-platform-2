...
provider with an `llm/mod.rs` and wires it into the LLM registry automatically.
Runtime adapters live beside LLM transforms under the same provider folder.
